...
// classe fatta con metodi come .persist che aggiunge elementi al database
// o .remove che rimuove gli elementi dal database
// e le query che servono per la ricerca
